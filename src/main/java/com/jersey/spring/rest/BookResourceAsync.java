...
import com.jersey.spring.rest.async.PATCH;
import com.jersey.spring.rest.async.PoweredBy;
import com.jersey.spring.service.BookDao;
import com.jersey.spring.service.model.Book;

@Path("/books")
public class BookResourceAsync {
	...
	EntityTag generateEntityTag(Book book) {
		return new EntityTag(
				DigestUtils.md5Hex(book.getAuthor() + book.getTitle() + book.getPublished() + book.getExtras()));
	}
}
